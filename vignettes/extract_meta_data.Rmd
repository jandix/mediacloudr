...
`httr` package 
[suggests](https://cran.r-project.org/web/packages/httr/vignettes/quickstart.html) 
...
tags with defined in the `css` argument. A useful open soure tool to find the 
...
article on Facebook. Larger analysis can use quantative tools such as string
